FROM ubuntu:16.04
LABEL author="onur.yukselen@umassmed.edu"  description="Docker image containing all requirements for the dolphinnext/m-construct QC  pipeline"
...
ENV PATH /opt/conda/envs/dolphinnext-m-constructqc-1.0/bin:$PATH
